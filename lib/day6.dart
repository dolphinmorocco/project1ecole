...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(leading:BackButton(onPressed: (){
      ...
      title: Text('  تكوين اليوم السادس ',style: TextStyle(fontSize: 20)),centerTitle: true,
    ),
    body: Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonWidget(
              ...
              text:'روائز و انشطة دعم الرياضيات اليوم السادس',
              onClicked: () async {
                const path = 'assets/روائز و انشطة دعم الرياضيات اليوم السادس.pdf';
            ...
            ButtonWidget(
              ...
              text: ' تقرير اليوم السادس',
              onClicked: () async {
                const path = 'assets/تقرير اليوم السادس.pdf';
                final file = await PDFApi.loadAsset(path);
                openPDF(context, file);
              },
            ),
