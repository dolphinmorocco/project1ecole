...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(leading:BackButton(onPressed: (){
      ...
      title: Text('  تكوين اليوم الثامن ',style: TextStyle(fontSize: 20)),centerTitle: true,
    ),
    body: Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonWidget(
              ...
              text:'تكوين الرياضيات اليوم الثامن ',
              onClicked: () async {
                const path = 'assets/تكوين الرياضيات اليوم الثامن.pdf';
